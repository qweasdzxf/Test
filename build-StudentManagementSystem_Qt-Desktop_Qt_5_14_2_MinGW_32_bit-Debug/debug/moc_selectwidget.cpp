...
#include <memory>
#include "../../StudentManagementSystem_Qt/selectwidget.h"
...
QT_MOC_LITERAL(5, 53, 23) // "on_selectButton_clicked"

    },
    "SelectWidget\0display\0\0number\0"
    "on_returnButton_clicked\0on_selectButton_clicked"
};
...
void SelectWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SelectWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SelectWidget::display)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SelectWidget::display(int _t1)
{
