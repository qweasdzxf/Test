...
#include "../../StudentManagementSystem_Qt/sortwidget.h"
...
QT_MOC_LITERAL(5, 51, 21) // "on_sortButton_clicked"

    },
    "SortWidget\0display\0\0number\0"
    "on_returnButton_clicked\0on_sortButton_clicked"
};
...
void SortWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SortWidget::display)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject SortWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SortWidget.data,
      qt_meta_data_SortWidget,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void SortWidget::display(int _t1)
{
