...
#include "../../StudentManagementSystem_Qt/addstudentwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddStudentWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AddStudentWidget_t qt_meta_stringdata_AddStudentWidget = {
    {
QT_MOC_LITERAL(0, 0, 16), // "AddStudentWidget"
QT_MOC_LITERAL(1, 17, 7), // "display"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 6), // "number"
QT_MOC_LITERAL(4, 33, 23), // "on_returnButton_clicked"
QT_MOC_LITERAL(5, 57, 20) // "on_addButton_clicked"

    },
    "AddStudentWidget\0display\0\0number\0"
...
void AddStudentWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AddStudentWidget *_t = static_cast<AddStudentWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (AddStudentWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddStudentWidget::display)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject AddStudentWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AddStudentWidget.data,
      qt_meta_data_AddStudentWidget,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void AddStudentWidget::display(int _t1)
{
